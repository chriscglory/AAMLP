...
diabetic_data=diabetic_data %>% select(-examide, -citoglipton,-acetohexamide,-troglitazone,-tolazamide,-glimepiride.pioglitazone, -metformin.rosiglitazone,-metformin.pioglitazone，-chlorpropamide,-tolbutamide,-miglitol,-glyburide.metformin,-glipizide.metformin,-acarbose)
...
# }
# 
# pairs(cleanData[names], lower.panel = panel.cor)
...
plot(lr.roc, col="red")
legend("topright",legend=round(lr.roc$auc,4),pch=20, pt.cex=2)
